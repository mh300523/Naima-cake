$(document).ready(function () {
    ...
    var bestseller = new Swiper('.pro_slider .swiper-container', {
        slidesPerView: 4,
        spaceBetween: 29,
        loop: true,
        observer: true,
        observeParents: true,
        pagination: {
            el: '.pro_slider .swiper-pagination',
            clickable: true,
        },
        navigation: {
            nextEl: '.pro_slider .swiper-button-next',
            prevEl: '.pro_slider .swiper-button-prev',
        },
        breakpoints: {
            0: {
                slidesPerView: 1,
